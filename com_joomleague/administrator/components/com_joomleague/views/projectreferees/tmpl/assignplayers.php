...
if($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_joomleague&task=projectreferees.saveOrderAjax&tmpl=component';
	HTMLHelper::_('sortablelist.sortable','ProjectrefeeList','adminForm',strtolower($listDirn),$saveOrderingUrl);
}
?>
<script>
...
<form action="<?php echo Route::_('index.php?option=com_joomleague&view=projectreferees&layout=assignplayers'); ?>" method="post" id="adminForm" name="adminForm">
				...
				?>
					<tr class="row<?php echo $i % 2; ?>">
						...
						<td class="center">
							...
							if ($birthday == '0000-00-00' || $birthday == '01-01-1970' || $birthday == '00-00-0000') {
								// don't display date
							} else {
								echo $birthday;
							}
