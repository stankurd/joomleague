...
if($saveOrder)
{
	...
	JHtml::_('sortablelist.sortable','ProjectrefeeList','adminForm',strtolower($listDirn),$saveOrderingUrl);
}
?>
<script>
...
<form action="<?php echo JRoute::_('index.php?option=com_joomleague&view=projectreferees&layout=assignplayers'); ?>" method="post" id="adminForm" name="adminForm">
