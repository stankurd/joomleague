...
if($saveOrder)
{
	...
	JHtml::_('sortablelist.sortable','leagueList','adminForm',strtolower($listDirn),$saveOrderingUrl);
}
?>
<form action="<?php echo JRoute::_('index.php?option=com_joomleague&view=leagues'); ?>" method="post" id="adminForm" name="adminForm">
	...
	<table class="table table-striped" id="leagueList">
		<thead>
			<tr>
				...
				<th>
					<?php echo JHtml::_('searchtools.sort','COM_JOOMLEAGUE_ADMIN_LEAGUES_NAME','a.name',$listDirn, $listOrder);?>
				</th>
				<th>
					<?php echo JHtml::_('searchtools.sort','COM_JOOMLEAGUE_ADMIN_LEAGUES_SHORT_NAME','a.short_name',$listDirn, $listOrder);?>
				</th>
				<th width="10%" class="center">
					<?php echo JHtml::_('searchtools.sort','COM_JOOMLEAGUE_ADMIN_LEAGUES_COUNTRY','a.country',$listDirn, $listOrder);?>
				</th>
				<th width="1%">
		...
		foreach($this->items as $i=>$row):
			$link = JRoute::_('index.php?option=com_joomleague&task=league.edit&id='.$row->id);
