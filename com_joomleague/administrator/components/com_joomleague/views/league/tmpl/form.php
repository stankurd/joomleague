...
Factory::getDocument()->addScriptDeclaration('
	...
	{
		if (task == "league.cancel" || document.formvalidator.isValid(document.getElementById("adminForm")))
		{
...
');
?>
<form action="<?php echo JRoute::_('index.php?option=com_joomleague&layout=form&id='.(int) $this->item->id); ?>" method="post" id="adminForm" name="adminForm">
	<?php
	$p = 1;
