...
Factory::getDocument()->addScriptDeclaration('
	...
	{
		if (task == "teamplayer.cancel" || document.formvalidator.isValid(document.getElementById("adminForm")))
		{
...
<form action="<?php echo Route::_('index.php?option=com_joomleague&layout=form&id='.(int)$this->item->id); ?>" method="post" id="adminForm" name="adminForm" class="form-validate">
	...
	if(Factory::getUser()->authorise('core.admin','com_joomleague') ||
			 Factory::getUser()->authorise('core.admin','com_joomleague.project.'.(int) $this->project->id))
	{
	...
	<input type="hidden" name="team_id" value="<?php echo $this->projectteam->team_id; ?>" />
