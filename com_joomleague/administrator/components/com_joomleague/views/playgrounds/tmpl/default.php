...
if($saveOrder)
{
	...
	JHtml::_('sortablelist.sortable','playgroundList','adminForm',strtolower($listDirn),$saveOrderingUrl);
}
?>
<form action="<?php echo JRoute::_('index.php?option=com_joomleague&view=playgrounds'); ?>" method="post" id="adminForm" name="adminForm">
	...
	<table class="table table-striped" id="playgroundList">
		<thead>
			<tr>
				...
				<th width="20">&nbsp;</th>
				<th>
					<?php echo JHtml::_('searchtools.sort','COM_JOOMLEAGUE_ADMIN_PLAYGROUNDS_NAME','a.name',$listDirn, $listOrder);?>
				</th>
				<th>
					<?php echo JHtml::_('searchtools.sort','COM_JOOMLEAGUE_ADMIN_PLAYGROUNDS_S_NAME','a.short_name',$listDirn, $listOrder);?>
				</th>
				<th>
					<?php echo JHtml::_('searchtools.sort','COM_JOOMLEAGUE_ADMIN_PLAYGROUNDS_CLUBNAME','club',$listDirn, $listOrder);?>
				</th>
				<th class="center">
					<?php echo JHtml::_('searchtools.sort','COM_JOOMLEAGUE_ADMIN_PLAYGROUNDS_CAPACITY','a.max_visitors',$listDirn, $listOrder);?>
				</th>
				<th>
		...
		foreach($this->items as $i=>$row) :
			$link = JRoute::_('index.php?option=com_joomleague&task=playground.edit&id='.$row->id);
