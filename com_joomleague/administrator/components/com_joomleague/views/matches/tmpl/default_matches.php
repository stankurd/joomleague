			...
			<table class="table table-striped">
				...
				<tbody>
					...
					foreach ($this->items as $i => $row) :
						$link = JRoute::_('index.php?option=com_joomleague&task=match.edit&id='.$row->id);
						$checked	= JHtml::_('grid.checkedout',$row,$i,'id');
						$published	= JHtml::_('jgrid.published', $row->published, $i, 'matches.');
						?>
						...
						<?php if(($row->cancel)>0)
							...
							<td class="left">
								...
								<a	href="javascript:void(0)"
									...
									<?php echo JHtml::image('administrator/components/com_joomleague/assets/images/arrow_open.png',
							...
							<td class="right" >
								<a	onclick="handleRosterIconClick(<?php echo $prefill; ?>, this, '<?php echo JText::_('COM_JOOMLEAGUE_ADMIN_MATCH_PREFILL_LAST_ROSTER_ALERT'); ?>', '<?php echo JText::_('COM_JOOMLEAGUE_ADMIN_MATCH_PREFILL_PROJECTTEAM_PLAYERS_ALERT')?>')"
									href="<?php echo JRoute::_('index.php?option=com_joomleague&view=match&layout=editlineup&match_id='.$row->id.'&team_id='.$row->projectteam1_id.'&prefill='); ?>"
									...
									echo '<sub>'.$row->homeplayers_count.'</sub> ';
									 ...
									 echo JHtml::image('administrator/components/com_joomleague/assets/images/'.$image,
							...
							<td class="left" >
								...
								?>
								<a	onclick="handleRosterIconClick(<?php echo $prefill; ?>, this, '<?php echo JText::_('COM_JOOMLEAGUE_ADMIN_MATCH_PREFILL_LAST_ROSTER_ALERT'); ?>', '<?php echo JText::_('COM_JOOMLEAGUE_ADMIN_MATCH_PREFILL_PROJECTTEAM_PLAYERS_ALERT')?>')"
									href="<?php echo JRoute::_('index.php?option=com_joomleague&view=match&layout=editlineup&match_id='.$row->id.'&team_id='.$row->projectteam2_id.'&prefill=');?>"
							...
							<td class="center">
								<a	onclick="handleRosterIconClick(<?php echo $prefill; ?>, this, '<?php echo JText::_('COM_JOOMLEAGUE_ADMIN_MATCH_PREFILL_LAST_ROSTER_ALERT'); ?>', '<?php echo JText::_('COM_JOOMLEAGUE_ADMIN_MATCH_PREFILL_PROJECTTEAM_PLAYERS_ALERT')?>')"
									...
									title="<?php echo JText::_('COM_JOOMLEAGUE_ADMIN_MATCHES_EDIT_EVENTS'); ?>">
									 <?php
									 echo JHtml::image('administrator/components/com_joomleague/assets/images/events.png',
							...
							<td class="center">
								...
								<a
									href="<?php echo JRoute::_('index.php?option=com_joomleague&view=match&layout=editreferees&match_id='.$row->id.'&team_id='.$row->projectteam1_id); ?>"
