			...
			<tbody>
				...
				<tr>
					<td nowrap='nowrap' class="key hasTip"
						title="<?php echo JText::_('COM_JOOMLEAGUE_ADMIN_ROUNDS_POPULATE_TYPE_LABEL').'::'.JText::_('COM_JOOMLEAGUE_ADMIN_ROUNDS_POPULATE_TYPE_TIP'); ?>">
				...
				<tr>
					<td nowrap='nowrap' class="key hasTip"
						title="<?php echo JText::_('COM_JOOMLEAGUE_ADMIN_ROUNDS_POPULATE_STARTTIME_LABEL').'::'.JText::_('COM_JOOMLEAGUE_ADMIN_ROUNDS_POPULATE_STARTTIME_TIP'); ?>">
				...
				<tr>
					<td nowrap='nowrap' class="key hasTip"
						title="<?php echo JText::_('COM_JOOMLEAGUE_ADMIN_ROUNDS_POPULATE_MATCHNUMBER_LABEL').'::'.JText::_('COM_JOOMLEAGUE_ADMIN_ROUNDS_POPULATE_MATCHNUMBER_TIP'); ?>">
						<label for="time"><?php echo JText::_('COM_JOOMLEAGUE_ADMIN_ROUNDS_POPULATE_MATCHNUMBER_LABEL'); ?></label>
					</td>
				...
				<tr>
					<td nowrap='nowrap' class="key hasTip"
						title="<?php echo JText::_('COM_JOOMLEAGUE_ADMIN_ROUNDS_POPULATE_ROUNDS_INTERVAL_LABEL').'::'.JText::_('COM_JOOMLEAGUE_ADMIN_ROUNDS_POPULATE_ROUNDS_INTERVAL_TIP'); ?>">
				...
				<tr>
					<td nowrap='nowrap' class="key hasTip"
						title="<?php echo JText::_('COM_JOOMLEAGUE_ADMIN_ROUNDS_POPULATE_NEW_ROUND_NAME_LABEL').'::'.JText::_('COM_JOOMLEAGUE_ADMIN_ROUNDS_POPULATE_NEW_ROUND_NAME_TIP'); ?>">
					...
					<td><input type="text" name="roundname"
						value="<?php echo JText::_('COM_JOOMLEAGUE_ADMIN_ROUNDS_POPULATE_NEW_ROUND_NAME'); ?>" /></td>
				</tr>
