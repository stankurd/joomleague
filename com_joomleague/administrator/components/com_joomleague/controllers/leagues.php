...
class JoomleagueControllerLeagues extends JLGControllerAdmin
{
	...
	public function remove()
	{
		...
		else
		{
			...
			if($result['error'])
			{
				$app->enqueueMessage(JText::_('COM_JOOMLEAGUE_LEAGUES_UNABLETODELETE'),'warning');
	...
	{
		$this->setRedirect(JRoute::_('index.php?option=com_joomleague&view=import&table=league',false));
	}
