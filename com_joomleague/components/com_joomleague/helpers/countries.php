 ...
 * Joomleague
 *
 * @copyright	Copyright (C) 2010-2015 joomleague.at. All rights reserved.
...
class Countries
{
	...
	public static function getCountries()
	{
		...
		$country["ALB"]= Array("iso2" => "AL", "name" => "ALBANIA__REPUBLIC_OF");
		...
		$country["ATA"]= Array("iso2" => "AQ", "name" => "ANTARCTICA__THE_TERRITORY_SOUT");
		...
		$country["BEL"]= Array("iso2" => "BE", "name" => "BELGIUM_KINGDOM_OF");
		...
		$country["BVT"]= Array("iso2" => "BV", "name" => "BOUVET_ISLAND__BOUVETOYA");
		...
		$country["CMR"]= Array("iso2" => "CM", "name" => "CAMEROON_REPUBLIC_OF");
		...
		$country["HKG"]= Array("iso2" => "HK", "name" => "HONG_KONG__SPECIAL_ADMINISTRAT");
		...
		$country["SMR"]= Array("iso2" => "SM", "name" => "SAN_MARINO__REPUBLIC_OF");
		...
		$country["SVK"]= Array("iso2" => "SK", "name" => "SLOVAKIA__SLOVAK_REPUBLIC_");
	...
	public static function getIso3Flag($iso_code_3)
	{
		...
		if ($iso2)
		{
			$path=Uri::root().'media/com_joomleague/flags/'.strtolower($iso2).'.png';
			return $path;
		}
		return null;
	}
