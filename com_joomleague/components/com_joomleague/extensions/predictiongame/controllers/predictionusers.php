...
class JoomleagueControllerPredictionUsers extends JLGController
{
	...
	function savememberdata()
	{
		...
		$mdlusers       = BaseDatabaseModel::getInstance("predictionusers", "JoomleagueModel");
		$model          = BaseDatabaseModel::getInstance("prediction", "JoomleagueModel");
