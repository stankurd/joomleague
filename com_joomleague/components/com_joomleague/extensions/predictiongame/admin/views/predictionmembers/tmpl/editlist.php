...
JToolBarHelper::title( Text::_( 'COM_JOOMLEAGUE_ADMIN_PREDICTIONMEMBERS_ASSIGN' ) );
#JToolBarHelper::title( $this->projectws->name . ' - ' . Text::_( 'Teams' ) . ' ' );
JLToolBarHelper::save( 'predictionmember.save_memberlist' );

// for existing items the button is renamed `close` and the apply button is showed
JLToolBarHelper::cancel( 'predictionmember.cancel', 'JL_GLOBAL_CLOSE');
...
//echo HTMLHelper::script('components/com_joomleague/extensions/predictiongame/assets/js/predictionmembers.js');
?>
...
<form action="<?php echo Route::_('index.php?option=com_joomleague');?>" method="post" name="adminForm" id="adminForm" class="form-validate">
	
    <fieldset>
		<div class="fltrt">
			<button type="button" onclick="Joomla.submitform('predictionmember.save_memberlist', this.form)">
	...
	<div class="col50">
		<fieldset class="adminform">
			<legend>
				<?php
				echo Text::sprintf( 'COM_JOOMLEAGUE_ADMIN_PREDICTIONMEMBERS_ASSIGN_TITLE', '<i>' . $this->prediction_name . '</i>');
				?>
			</legend>
			...
			<table class="admintable" border="0">
				<tr>
					<td>
						<b>
							<?php
							echo Text::_( 'COM_JOOMLEAGUE_ADMIN_PREDICTIONMEMBERS_ASSIGN_AVAIL_MEMBERS' );
							?>
						</b><br />
						<?php
					...
					<td>
						<b>
							<?php
							echo Text::_( 'COM_JOOMLEAGUE_ADMIN_PREDICTIONMEMBERS_ASSIGN_PROJ_MEMBERS' );
							?>
						</b><br />
						<?php
