...
if ((!isset($this->actJoomlaUser)) || ($this->actJoomlaUser->id==0))
{
	...
	?></p><p><?php
	echo Text::sprintf(	'If you already have an account of this site, you must first %1$1s[LogIn]%2$s by using the Joomla-LogIn-Page.',
							'<b><i><a href="index.php?option=com_users&view=login">',
							'</i></b></a>');
	?></p><p><?php
	echo Text::sprintf(	'If you are not registered on this website yet, you can do by clicking on %1$1s[Register]%2$s.',
							'<b><i><a href="index.php?option=com_users&view=registration">',
							'</i></b></a>');
	?></p><?php
}
else
