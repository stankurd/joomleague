...
<form name='adminForm' id='adminForm' method='post' >
	...
	<table class='plinfo' cellpadding='4' cellspacing='1'>
        ...
        <tr>
            ...
            {
            echo '<br>';
            echo '<font size="2" color="red">'.Text::_('COM_JOOMLEAGUE_PRED_USERS_EDIT_LABEL_NO_GROUP_CHANGE').'</font>';  
            } 
            ?>
            </td>
		</tr>
...
//echo '<br /><pre>~' . print_r($predictionProject,true) . '~</pre><br />';
            ...
            echo '<font size="2" color="red">'.Text::_('COM_JOOMLEAGUE_PRED_USERS_EDIT_LABEL_NO_GROUP_CHANGE').'</font><br>';    
            } 
						?><?php
