...
if (document.getElementById(containerid).style.display=='none') {
	...
	var url="<?php echo 'index.php?option=com_joomleague&task=editmatch.load&p='.$joomleague->id.'&mid=';?>"+matchid;
	...
	var url="<?php echo 'index.php?option=com_joomleague&task=editmatch.cancel&p='.$joomleague->id."&mid=";?>"+matchid;
	var answer = confirm ("<?php echo Text::_('COM_JOOMLEAGUE_EDIT_FORM_RESULTS_CONFIRM');?>")
	if (answer) {
