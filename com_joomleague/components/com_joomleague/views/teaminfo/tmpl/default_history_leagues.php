...
<table width="100%" class="contentpaneopen">
	<tr>
		<td class="contentheading"><?php echo '&nbsp;' . JText::_('COM_JOOMLEAGUE_TEAMINFO_HISTORY_PER_LEAGUE_SUMMARY'); ?>
		</td>
	</tr>
</table>
...
<legend>
<strong>
<?php echo JText::_('COM_JOOMLEAGUE_TEAMINFO_HISTORY_OVERVIEW_SUMMARY'); ?>
</strong>
</legend>
...
<?PHP echo JText::_( 'COM_JOOMLEAGUE_TEAMINFO_LEAGUE' ); ?>
</th>
<th class="title" nowrap="nowrap" style="vertical-align:top;background:#BDBDBD; ">
<?PHP echo JText::_( 'COM_JOOMLEAGUE_TEAMINFO_TOTAL_GAMES' ); ?>
</th>
<th class="title" nowrap="nowrap" style="vertical-align:top;background:#BDBDBD; ">
<?PHP echo JText::_( 'COM_JOOMLEAGUE_TEAMINFO_TOTAL_WDL' ); ?>
</th>

<th class="title" nowrap="nowrap" style="vertical-align:top;background:#BDBDBD; ">
<?PHP echo JText::_( 'COM_JOOMLEAGUE_TEAMINFO_TOTAL_GOALS' ); ?>
</th>
