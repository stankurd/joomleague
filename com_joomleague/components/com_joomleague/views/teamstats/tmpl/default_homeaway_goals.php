...
<div class='jl_teamsubstats'>
	...
	<thead>
		<tr class='sectiontableheader'>
			<th colspan='2'><?php echo JText::_('COM_JOOMLEAGUE_TEAMSTATS_HOME_STATS'); ?></th>
		</tr>
	</thead>
	<tbody>
		<tr class='sectiontableentry1'>
			<td class='statlabel'><?php echo JText::_('COM_JOOMLEAGUE_TEAMSTATS_HOME_GAME_PERCENTAGE'); ?>:</td>
...
<div class='jl_teamsubstats'>
	...
	<thead>
		<tr class='sectiontableheader'>
			<th colspan='2'><?php echo JText::_('COM_JOOMLEAGUE_TEAMSTATS_AWAY_STATS'); ?></th>
		</tr>
	</thead>
	<tbody>
		<tr class='sectiontableentry1'>
			<td class='statlabel'><?php echo JText::_('COM_JOOMLEAGUE_TEAMSTATS_AWAY_GAME_PERCENTAGE'); ?>:</td>
