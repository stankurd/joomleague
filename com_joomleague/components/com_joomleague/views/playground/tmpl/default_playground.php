...
<table width='96%' align='center' border='0' cellpadding='0' cellspacing='0' class='venueinfo'>
	...
	<tr>
		<th class='td_r' width='30%'><?php echo JText::_('COM_JOOMLEAGUE_PLAYGROUND_SHORT'); ?></th>
	...
	<tr>
		<th class='td_r_t' width='30%'><?php echo JText::_('COM_JOOMLEAGUE_PLAYGROUND_ADDRESS'); ?></th>
		<td width='70%'>
			<?php
	...
	<tr>
		<th class='td_r' width='30%'><?php echo JText::_('COM_JOOMLEAGUE_PLAYGROUND_MAX_VISITORS'); ?></th>
