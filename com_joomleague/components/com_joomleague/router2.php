...
$paramscomponent = JComponentHelper::getParams('com_joomleague');
if (!defined('com_joomleague_SHOW_DEBUG_INFO')) {
    DEFINE('com_joomleague_SHOW_DEBUG_INFO', $paramscomponent->get('show_debug_info'));
}
/*
if (!class_exists('joomleagueHelper')) {
    require_once (JPATH_ADMINISTRATOR . DS . JLG_PATH . DS . 'helpers' . DS .
            'joomleague.php');
}
*/
...
// Joomla! 4.0 code here
    defined('JLG_JVERSION') or define('JLG_JVERSION', 4);
    
}
if (version_compare($baseVersion, '3.0', 'ge')) {
// Joomla! 3.0 code here
    defined('JLG_JVERSION') or define('JLG_JVERSION', 3);
    
}
if (version_compare($baseVersion, '2.5', 'ge')) {
// Joomla! 2.5 code here
    defined('JLG_JVERSION') or define('JLG_JVERSION', 2);
}
    ...
    public function parse(&$segments) {
        ...
        switch ($vars['view']) { // the view...
            ...
            case 'event':
                ...
                $vars['Itemid'] = JLGGCalendarUtil::getItemId($vars['gcid']);
                break;
