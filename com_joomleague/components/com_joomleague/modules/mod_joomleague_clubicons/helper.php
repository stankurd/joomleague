...
class modJLClubiconsHelper
{
	...
	private function _getData()
	{
		...
		$project_id = ($app->input->getVar('option','') == 'com_joomleague' AND 
	...
	function getLogo( & $item, $class )
	{
		...
		//echo $logourl.'<br />';
		$imgtitle = Text::_('View ') . $item->team_name;
		return HTMLHelper::image($logourl, $item->team_name,'border="0" class="'.$class.'" title="'.$imgtitle.'"');
	}
